...
int initOcl(ocl_daisy_programs * daisy, ocl_constructs * ocl){
  ...
  oclError("initOcl", "clCreateKernel (Den)", error);
  ...
  oclError("oclDaisy", "clCreateKernel (G0)", error);
  ...
  oclError("oclDaisy", "clCreateKernel (G1)", error);
  ...
  oclError("oclDaisy", "clCreateKernel (G2)", error);
